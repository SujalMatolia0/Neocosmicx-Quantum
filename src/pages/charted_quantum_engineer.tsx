...
import { QuantumEngineerHero } from '@/components/pages/quantum_engineer/hero';
import { QuantumEngineerSection1 } from '@/components/pages/quantum_engineer/section1';
import { QuantumEngineerSection2 } from '@/components/pages/quantum_engineer/section2';
import { QuantumEngineerSection3 } from '@/components/pages/quantum_engineer/section3';
const FAQ_DATA = [
  {
